...
index.add(xb)   
index.search_mode = 0
util.write_tsv(index.hnsw, "index.tsv")
print("search")
for efSearch in 100,200,300,400,500,600,700,800,900,1000,2000,3000,4000,5000,6000,7000,8000,9000,10000,12000,14000,16000,18000,20000,25000,30000,35000,40000:
