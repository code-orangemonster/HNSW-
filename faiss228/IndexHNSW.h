...
struct IndexHNSW : Index {
    ...
    */
    void combine_index_with_hot_hubs_enhence(idx_t n,int len_ratios,
            ...
            int find_neighbors_mode, const int* max_rvs_nb_per_level,idx_t* I);
...
/*    void enhence_index_with_subIndex_hubs(idx_t n,int len_ratios,
    ...
    void out_indegrees();
    void out_indegrees2();
    void write_index_to_CSV();
    void out_HubsIDs_and_its_reverse_nbs();
    ...
    void search_from_hubs_to_nbs () const;
